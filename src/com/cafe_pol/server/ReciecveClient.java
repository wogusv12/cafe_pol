...
import com.cafe_pol.kiosk.Client;
import com.cafe_pol.kiosk.Shop_basket;

import java.io.*;
import java.net.Socket;

public class ReciecveClient {
    ...
    public static void main(String[] args) {
        ReciecveClient cl = new ReciecveClient();
        try{
            cl.SocketStart(); // 소캣 개설
            cl.ClientRun("12");  // 데이터 전송
    ...
    public void SocketStart(){
        try {
            socket = new Socket("localhost", 4202);
